...
public class MyAdapter_appointments_withviewholder_v1 extends BaseAdapter  {
    //namae tampung;
...
private Boolean mapready=false;
    ...
    public MyAdapter_appointments_withviewholder_v1(Activity a, List<PasienList> pasienList) {
        /*activity = a;
        data=d;
        filteredData = d;
