...
private Boolean mapready=false;
    ...
    public MyAdapter(Activity a, List<PasienList> pasienList) {
        /*activity = a;
        data=d;
        filteredData = d;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        PasienList mappingan = pasienList.get(position);
        if (convertView == null) {
                ...
                if (mappingan.getMasih_order()==false) {
                    ...
                    rl.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            MyApplication.getInstance().getPasienFromList().get(position).setMasih_order(true);
